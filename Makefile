#############################################################################
# Makefile for building: build_all
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  build_all.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile build_all.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = build_all1.0.0
DISTDIR = /app/.tmp/build_all1.0.0
SUBTARGETS    =  \
		sub-DWKeyboard-pro \
		sub-demo-demo-pro


sub-DWKeyboard-pro-qmake_all:  FORCE
	$(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro
	$(MAKE) -f Makefile.DWKeyboard qmake_all
sub-DWKeyboard-pro: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard
sub-DWKeyboard-pro-make_first: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard
sub-DWKeyboard-pro-all: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard all
sub-DWKeyboard-pro-clean: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard clean
sub-DWKeyboard-pro-distclean: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard distclean
sub-DWKeyboard-pro-install_subtargets: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard install
sub-DWKeyboard-pro-uninstall_subtargets: FORCE
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard uninstall
sub-demo-demo-pro-qmake_all:  FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && $(QMAKE) -o Makefile /app/demo/demo.pro
	cd demo/ && $(MAKE) -f Makefile qmake_all
sub-demo-demo-pro: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile
sub-demo-demo-pro-make_first: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile
sub-demo-demo-pro-all: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile all
sub-demo-demo-pro-clean: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile clean
sub-demo-demo-pro-distclean: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile distclean
sub-demo-demo-pro-install_subtargets: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile install
sub-demo-demo-pro-uninstall_subtargets: FORCE
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile uninstall

Makefile: build_all.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		build_all.pro
	$(QMAKE) -o Makefile build_all.pro
...
qmake_all: sub-DWKeyboard-pro-qmake_all sub-demo-demo-pro-qmake_all FORCE

make_first: sub-DWKeyboard-pro-make_first sub-demo-demo-pro-make_first  FORCE
all: sub-DWKeyboard-pro-all sub-demo-demo-pro-all  FORCE
clean: sub-DWKeyboard-pro-clean sub-demo-demo-pro-clean  FORCE
distclean: sub-DWKeyboard-pro-distclean sub-demo-demo-pro-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-DWKeyboard-pro-install_subtargets sub-demo-demo-pro-install_subtargets FORCE
uninstall_subtargets: sub-DWKeyboard-pro-uninstall_subtargets sub-demo-demo-pro-uninstall_subtargets FORCE

sub-DWKeyboard-pro-check:
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard check
sub-demo-demo-pro-check:
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile check
check: sub-DWKeyboard-pro-check sub-demo-demo-pro-check

sub-DWKeyboard-pro-benchmark:
	( test -e Makefile.DWKeyboard || $(QMAKE) -o Makefile.DWKeyboard /app/DWKeyboard.pro ) && $(MAKE) -f Makefile.DWKeyboard benchmark
sub-demo-demo-pro-benchmark:
	@test -d demo/ || mkdir -p demo/
	cd demo/ && ( test -e Makefile || $(QMAKE) -o Makefile /app/demo/demo.pro ) && $(MAKE) -f Makefile benchmark
benchmark: sub-DWKeyboard-pro-benchmark sub-demo-demo-pro-benchmark
